...
export default function page() {
    ...
    const handleAddFriend = async (data) => {
        // console.log(data)
        try {
            const a = await addFriend(data, session?.user?.token)
    ...
    const getNotifications = async () => {
        try {
            const data = await fetchNotifications(session?.user?.id, session?.user?.token)
                                            ...
                                            <div className="right">
                                                <div className="serach-msg">
                                                    ...
                                                    <div className='message'>
                                                        ...
                                                        <Link type='button' href="/chat" className='btn friend-request-btn accept'>
                                                            <i class="ri-question-answer-fill me-2"></i>
                                                            Chat
                                                        </Link>
                                                    </div>
                                                    <div>
                                                                    ...
                                                                    return (
                                                                        <li class="nav-item">
                                                                            <div className="friend-request">
                                                                                <div className="left">
                                                                                    <div className="friend-img border border-1 border-light shadow">
                                                                                        <img src={awsFileUrl ? awsFileUrl : '/assets/images/boy.png'} alt="" className='img-fluid' />
                                                                                    </div>
                                                                            ...
                                                                            <div className="friend-request">
                                                                                <div className="left">
                                                                                    ...
                                                                                    <div className="friend-info">
                                                                                        ...
                                                                                        <div className='d-flex'>
                                                                                            <p className='mutual-friends text-capitalize'>See mutual friends soon</p>
                                                                                            {/* <p className='time'>25m ago</p> */}
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
